...
package org.ehcache.myapp.outbound;
...
import org.ehcache.myapp.EhcacheAdapterHeaders;
...
public class EhcacheAdapterOutboundGateway extends
	...
	protected void onInit() {
		...
		if (mgr.getCache(CACHE_NAME) == null) {
			createCache(mgr);
		}
	...
	protected Object handleRequestMessage(Message<?> requestMessage) {
		...
		try {
			Cache cacheInstance = CacheManager.getInstance().getCache(CACHE_NAME);
